...
public class GymsDAO {
  ...
  //This function returns list of gyms starting by name specified
  ...
  public static void main(String args[])
	{	
		// Create an empty model
		GymsDAO dao = new GymsDAO();
		ArrayList<PlaceDTO> places = new ArrayList<PlaceDTO>();
		places = dao.getListByName("Muni");
		...
		//dao.getGymListByDistrict("pepe");
		//dao.getCoordinates("CentroDeportivoMunicipalAlfredoGoyeneche");
		
		// Use the FileManager to find the input file
		/*InputStream in = FileManager.get().open(dao.getRDF());
		if (in == null)
			throw new IllegalArgumentException("File: "+dao.getRDF()+" not found");*/
