...
public class Task6
{
	...
	public static void main(String args[])
	{
		...
		model.getOntClass(ns+"Researcher").createIndividual("Jane Smith");
		
		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and family names **
		model.getIndividual(ns+"Jane Smith").addProperty(VCARD.FN,"Jane Smith");
		model.getIndividual(ns+"Jane Smith").addProperty(VCARD.Given,"Jane Smith");
		model.getIndividual(ns+"Jane Smith").addProperty(VCARD.Family,"Jane Smith");
		
		
		// ** TASK 6.6: Add UPM as the university where John Smith works **
		Individual upm=model.getOntClass(ns+"University").createIndividual(ns+"UPM");
        Property work=model.getProperty(ns+"worksIn");
		model.getIndividual(ns+"John Smith").addProperty(work,upm);
